...
function EditProfile({ profile: { profile, loading }, profileEdit, setProfileEdit, createProfile, history, getCurrentProfile }) {
     ...
     const [values, handleChange] = useForm({
          ...
          githusername: profile?.githubusername ? profile?.githubusername : '',
     ...
     return (
          <Transition.Root show={profileEdit} as={Fragment}>
               <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={cancelButtonRef} onClose={setProfileEdit}>
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                         ...
                         >
                              <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                   <div className="mt-2">
                                        <div className="heading text-center font-bold text-2xl m-5 text-gray-800">Edit Profile</div>
                                   ...
                                   <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse pt-5 mb-10">
                                        <div class="buttons flex">
                                             <div class="btn border border-gray-300 p-1 px-4 font-semibold cursor-pointer text-gray-500 ml-auto" onClick={() => setProfileEdit(false)}>Cancel</div>
